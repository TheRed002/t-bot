...
class TestRepositoryFactory:
    ...
    def test_create_repository_with_di_not_registered(self, repository_factory_with_di, mock_session):
    ...
    def test_create_repository_with_di_registered_direct(self, repository_factory_with_di, mock_session):
    ...
    def test_create_repository_with_di_registered_container(self, repository_factory_with_di, mock_session):
