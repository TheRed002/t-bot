...
from src.database.seed_data import DatabaseSeeder, main, run_seed
...
class TestDatabaseSeeder:
    ...
    def test_database_seeder_init_production_error(self, mock_production_config):
        ...
        with pytest.raises(
            ValueError, match="Database seeding is only allowed in development mode"
        ):
...
class TestSeedDataFunctions:
    ...
    async def test_run_seed_without_config(self):
        ...
        with (
            patch("src.database.seed_data.Config") as mock_config_class,
