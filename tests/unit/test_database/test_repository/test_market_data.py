...
class TestMarketDataRepository:
    ...
    async def test_get_by_symbol(
        self, market_data_repository, mock_session, sample_market_data_list
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_exchange(
        self, market_data_repository, mock_session, sample_market_data_list
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_symbol_and_exchange(
        self, market_data_repository, mock_session, sample_market_data_list
    ):
    ...
    async def test_get_latest_price_found(
        self, market_data_repository, mock_session, sample_market_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_recent_data_default_hours(
        self, market_data_repository, mock_session, sample_market_data_list
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_data_source(
        self, market_data_repository, mock_session, sample_market_data_list
    ):
    ...
    async def test_get_poor_quality_data_no_poor_quality(self, market_data_repository):
        ...
        records = [Mock(quality_score=0.9), Mock(quality_score=0.95), Mock(quality_score=0.98)]
    ...
    async def test_cleanup_old_data_success(self, market_data_repository):
        ...
        with patch(
            "src.database.repository.utils.RepositoryUtils.cleanup_old_entities", return_value=3
        ):
    ...
    async def test_cleanup_old_data_custom_days(self, market_data_repository):
        ...
        # The cleanup_old_data method uses RepositoryUtils.cleanup_old_entities
        with patch(
            "src.database.repository.utils.RepositoryUtils.cleanup_old_entities", return_value=1
        ):
    ...
    @pytest.mark.asyncio
    async def test_get_volume_leaders_no_exchange_filter(
        self, market_data_repository, mock_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_volume_leaders_with_exchange_filter(
        self, market_data_repository, mock_session
    ):
    ...
    async def test_get_price_changes_sufficient_data(self, market_data_repository, mock_session):
        ...
        # Mock RepositoryUtils.execute_time_based_query directly 
        with patch("src.database.repository.utils.RepositoryUtils.execute_time_based_query", return_value=records):
...
class TestMarketDataRepositoryPerformance:
    ...
    async def test_batch_cleanup_operations(self, market_data_repository):
        ...
        # The cleanup_old_data method uses RepositoryUtils.cleanup_old_entities
        with patch(
            "src.database.repository.utils.RepositoryUtils.cleanup_old_entities", return_value=1000
        ):
            result = await market_data_repository.cleanup_old_data()
            assert result == 1000
    ...
    async def test_time_range_queries_performance(self, market_data_repository, mock_session):
        ...
        base_time = datetime.now(timezone.utc)
        time_series_data = [
            Mock(data_timestamp=base_time - timedelta(hours=i), symbol="BTCUSD", exchange="binance")
...
class TestMarketDataRepositoryEdgeCases:
    ...
    async def test_very_old_timestamps(self, market_data_repository):
        ...
        # The cleanup_old_data method uses RepositoryUtils.cleanup_old_entities
        with patch(
            "src.database.repository.utils.RepositoryUtils.cleanup_old_entities", return_value=100
        ):
