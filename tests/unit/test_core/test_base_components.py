...
from src.core.base.interfaces import Lifecycle, HealthCheckable, Injectable
from src.core.exceptions import ServiceError, ValidationError, ComponentError, EntityNotFoundError
...
class MockRepository(BaseRepository):
    ...
    async def _create_entity(self, entity):
        """Create entity."""
        entity_id = entity.get('id') if isinstance(entity, dict) else getattr(entity, 'id', id(entity))
    ...
    async def _list_entities(self, limit=None, offset=None, filters=None, order_by=None, order_desc=False):
        """List entities."""
