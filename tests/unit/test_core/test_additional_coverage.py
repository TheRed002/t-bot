...
class TestDependencyInjectionModules:
    ...
    def test_service_locator(self):
        ...
        try:
            from src.core.dependency_injection import ServiceLocator, DependencyInjector
...
class TestResourceManagerModules:
    ...
    def test_resource_info(self):
        """Test resource info."""
        try:
            from src.core.resource_manager import ResourceInfo, ResourceType, ResourceState
...
class TestPerformanceModules:
    ...
    def test_performance_optimizer(self):
        ...
        try:
            ...
            assert not optimizer.is_initialized  # Should not be initialized without calling initialize()
...
class TestExceptionHandling:
    ...
    def test_exception_creation_and_serialization(self):
        ...
        try:
            from src.core.exceptions import TradingBotError, ValidationError, ServiceError
            ...
            assert "[TEST_001] Test error" in str(error)  # String representation includes error code
