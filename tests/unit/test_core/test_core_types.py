...
class TestFinancialCalculationAccuracy:
    ...
    def test_position_pnl_calculations(self):
        ...
        expected_pnl = (long_position.current_price - long_position.entry_price) * long_position.quantity
        ...
        expected_short_pnl = (short_position.entry_price - short_position.current_price) * short_position.quantity
