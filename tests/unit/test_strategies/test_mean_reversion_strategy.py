...
class TestMeanReversionStrategy:
    ...
    def test_update_price_history_with_none_values(self, strategy):
        ...
        assert strategy.price_history[-1] == 50000.0
        assert strategy.volume_history[-1] == 100.0  # Should use actual volume value
    ...
    async def test_generate_signals_exit_signals(self, strategy, mock_market_data):
        ...
        # Use almost constant prices with tiny random variation to ensure Z-score is within exit threshold
        import numpy as np
    ...
    def test_should_exit_atr_stop_loss(self, strategy, mock_position, mock_market_data):
        ...
        # Create more realistic price data with proper high/low/close relationship
