...
class TestAdaptiveMomentumStrategy:
    ...
    async def test_calculate_momentum_score(self, strategy):
        ...
        # Add price history with enough data points (need at least slow_ma_period = 50)
    ...
    @pytest.mark.asyncio
    async def test_apply_regime_confidence_adjustments_with_manager(self, strategy, mock_adaptive_risk_manager):
    ...
    async def test_validate_signal_momentum_inconsistency(self, strategy, sample_signal):
        ...
        strategy.momentum_scores["BTC/USD"] = 0.9  # Different from signal's 0.5
