...
from src.error_handling.recovery import RetryRecovery, CircuitBreakerRecovery, FallbackRecovery
...
class TestErrorHandlerBase:
    ...
    def test_handler_chain(self):
        ...
        handler1.process = lambda e, c: handler1.next_handler.process(e, c) if handler1.next_handler else None
...
class TestErrorHandlerChain:
    ...
    def test_chain_building(self):
        ...
        # Build chain
        chain = ErrorHandlerChain(['network', 'validation'])
