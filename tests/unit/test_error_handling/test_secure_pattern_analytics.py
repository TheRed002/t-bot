...
class TestAnalyticsConfig:
    ...
    def test_analytics_config_defaults(self):
        ...
        assert config.threat_score_threshold == 7.0
...
class TestSecurePatternAnalytics:
    ...
    def analyzer(self, analyzer_config):
        ...
        with patch('src.error_handling.secure_pattern_analytics.get_security_sanitizer') as mock_sanitizer, \
    ...
    def test_record_error_basic(self, analyzer):
        ...
        analyzer.record_error_event(error, error_context.get("component", "unknown"), security_context, error_context)
    ...
    def test_detect_brute_force_pattern(self, analyzer):
        ...
        if patterns:
            ...
            if analyzer.config.enable_threat_detection:
                ...
                assert pattern.severity in [PatternSeverity.MEDIUM, PatternSeverity.HIGH, PatternSeverity.CRITICAL]
