...
class TestBaseCircuitBreaker:
    ...
    def test_circuit_breaker_reset(self, circuit_breaker):
        ...
        circuit_breaker.trigger_time = datetime.now(timezone.utc)
...
class TestSystemErrorRateBreaker:
    ...
    async def test_get_current_value_with_errors(self, breaker):
        ...
        breaker.error_times = [datetime.now(timezone.utc) for _ in range(5)]
    ...
    async def test_check_condition_trigger(self, breaker):
        """Test condition check when trigger should occur."""
        # Add many errors
        breaker.error_times = [datetime.now(timezone.utc) for _ in range(15)]
...
class TestCircuitBreakerManager:
    ...
    def test_initialization(self, manager):
        ...
        assert len(manager.circuit_breakers) == 6
    ...
    def test_reset_all(self, manager):
        ...
        manager.circuit_breakers["daily_loss_limit"].state = CircuitBreakerState.TRIGGERED
