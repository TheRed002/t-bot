...
from src.core.types.trading import SignalDirection
...
class TestPositionSizer:
    ...
    async def test_calculate_position_size_max_limit(self, position_sizer, sample_signal):
        ...
        sample_signal.confidence = 1.0  # Update both attributes
    ...
    async def test_validate_position_size_exception(self, position_sizer):
        ...
        # Mock to_decimal to raise an exception directly
        with patch("src.risk_management.position_sizing.to_decimal") as mock_to_decimal:
            mock_to_decimal.side_effect = Exception("Invalid decimal conversion")
