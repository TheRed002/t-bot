...
class TestPortfolioLimits:
    ...
    def test_check_total_positions_limit(self, portfolio_limits, new_position):
        """Test total positions limit checking."""
        # Add maximum positions
        portfolio_limits.positions = [Mock() for _ in range(10)]  # Max positions
        portfolio_limits.total_portfolio_value = Decimal("10000")

        result = portfolio_limits._check_total_positions_limit(new_position)

        assert result is False

    def test_check_positions_per_symbol_limit(self, portfolio_limits, new_position):
        ...
        result = portfolio_limits._check_positions_per_symbol_limit(new_position)

        assert result is False

    def test_check_portfolio_exposure_limit(self, portfolio_limits, new_position):
        ...
        result = portfolio_limits._check_portfolio_exposure_limit(new_position)

        assert result is False

    def test_check_sector_exposure_limit(self, portfolio_limits, new_position):
        ...
        result = portfolio_limits._check_sector_exposure_limit(new_position)

        assert result is False

    def test_check_correlation_exposure_limit(self, portfolio_limits, new_position):
        ...
        result = portfolio_limits._check_correlation_exposure_limit(new_position)

        # Should pass if correlation is not high enough
        assert result is True

    def test_check_leverage_limit(self, portfolio_limits, new_position):
        """Test leverage limit checking."""
        result = portfolio_limits._check_leverage_limit(new_position)
