...
class TestPortfolioLimits:
    ...
    async def test_check_correlation_exposure_limit(self, portfolio_limits, new_position):
        ...
        portfolio_limits.return_history["ADAUSDT"] = [0.01, 0.02, 0.01, 0.02, 0.01] * 10  # High correlation
    ...
    async def test_update_return_history(self, portfolio_limits):
        ...
        assert len(portfolio_limits.return_history[symbol]) == 0  # First price, no return yet
    ...
    async def test_update_return_history_with_previous_price(self, portfolio_limits):
        ...
        assert portfolio_limits.return_history[symbol][0] == 0.02  # (51000-50000)/50000
    ...
    @pytest.mark.asyncio
    async def test_get_portfolio_summary(self, portfolio_limits, sample_position, sample_position_eth):
