...
class TestKellyCriterionPrecision:
    ...
    def test_kelly_edge_case_zero_variance(self, position_sizer, sample_signal):
    ...
    def test_kelly_extreme_variance_scenarios(self, position_sizer, sample_signal):
    ...
    def test_kelly_confidence_weighting_accuracy(self, position_sizer):
        ...
        for confidence in confidence_levels:
            ...
            size = position_sizer._kelly_criterion_sizing(signal, portfolio_value)
    ...
    def test_kelly_historical_window_sensitivity(self, position_sizer, sample_signal):
        ...
        for window_size, window_name in window_tests:
            ...
            size = position_sizer._kelly_criterion_sizing(sample_signal, portfolio_value)
    ...
    def test_kelly_with_real_market_scenarios(self, position_sizer, sample_signal):
        """Test Kelly with realistic market return scenarios."""
        portfolio_value = Decimal("10000")
        
        # Realistic crypto market scenarios
        market_scenarios = {
            "bull_market": [0.05, 0.03, 0.07, 0.02, 0.04, 0.06, 0.01, 0.03] * 4,  # Generally positive
            "bear_market": [-0.03, -0.05, -0.02, 0.01, -0.04, -0.01, -0.06, 0.02] * 4,  # Generally negative  
    ...
    def test_kelly_calculation_consistency(self, position_sizer, sample_signal):
    ...
    def test_kelly_numerical_stability(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_kelly_integration_with_calculate_position_size(self, position_sizer, sample_signal):
    ...
    def test_kelly_statistical_properties(self, position_sizer, sample_signal):
    ...
    def test_kelly_fallback_behavior(self, position_sizer, sample_signal):
    ...
    def test_kelly_performance_benchmarks(self, position_sizer, sample_signal):
    ...
    def test_kelly_with_different_distributions(self, position_sizer, sample_signal):
        ...
        distribution_tests = [
            ...
            (np.concatenate([np.random.normal(-0.02, 0.01, 15), 
                            np.random.normal(0.03, 0.01, 15)]).tolist(), "bimodal"),
        ]
