...
MOCK_MODULES = {
    ...
    'src.error_handling.decorators': Mock(
        with_error_handling=lambda func: func,
        shutdown_all_error_handlers=AsyncMock()
    ),
