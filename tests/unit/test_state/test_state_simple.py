...
os.environ.update(
    {"TESTING": "1", "DISABLE_TELEMETRY": "1", "DISABLE_LOGGING": "1", "PYTHONHASHSEED": "0"}
)
...
class TestSimpleStateOperations:
    ...
    def test_checkpoint_data_structure(self):
        ...
        checkpoint_data = {
            ...
            "entity_id": "bot-123",
            "timestamp": datetime.now(timezone.utc).isoformat(),
            "state_data": {"bot_id": "bot-123", "status": "running", "capital": "1000.0"},
            "metadata": {"created_by": "test", "checkpoint_type": "manual"},
        }
