...
class TestPositionSizer:
    ...
    async def test_calculate_position_size_fixed_percentage(self, position_sizer, sample_signal):
        ...
        expected_size = portfolio_value * Decimal("0.02") * Decimal(str(sample_signal.confidence))
        assert position_size == expected_size
    
    @pytest.mark.asyncio
    async def test_calculate_position_size_kelly_criterion(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_kelly_insufficient_data(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_volatility_adjusted(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_volatility_insufficient_data(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_confidence_weighted(self, position_sizer, sample_signal):
        ...
        expected_size = portfolio_value * Decimal("0.02") * Decimal(str(sample_signal.confidence ** 2))
        assert position_size == expected_size
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_max_limit(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_invalid_signal(self, position_sizer):
    ...
    @pytest.mark.asyncio
    async def test_calculate_position_size_invalid_portfolio_value(self, position_sizer, sample_signal):
        """Test position sizing with invalid portfolio value."""
        with pytest.raises(RiskManagementError):
            await position_sizer.calculate_position_size(sample_signal, Decimal("0"))
    
    @pytest.mark.asyncio
    async def test_calculate_position_size_unsupported_method(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_kelly_criterion_zero_variance(self, position_sizer, sample_signal):
        ...
        assert position_size > 0
        assert position_size <= portfolio_value * Decimal(str(position_sizer.risk_config.max_position_size_pct))
    
    @pytest.mark.asyncio
    async def test_volatility_adjusted_sizing(self, position_sizer, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_confidence_weighted_sizing(self, position_sizer, sample_signal):
    ...
    async def test_update_price_history_return_calculation(self, position_sizer):
        ...
        assert position_sizer.return_history[symbol][0] == 0.02  # (51000-50000)/50000
    ...
    @pytest.mark.asyncio
    async def test_get_position_size_summary(self, position_sizer, sample_signal):
    ...
    def test_volatility_calculation_accuracy(self, position_sizer, sample_signal):
        ...
        # This test verifies the mathematical accuracy of volatility calculation
