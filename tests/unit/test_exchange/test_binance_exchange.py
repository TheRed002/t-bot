...
def mock_config():
    ...
    # Create exchange mock with specific attributes matching ExchangeConfig
    exchange_mock = MagicMock()
    exchange_mock.binance_api_key = "test_api_key"
    exchange_mock.binance_api_secret = "test_api_secret"
    exchange_mock.binance_testnet = True
    exchange_mock.binance_websocket_interval = "100ms"
    exchange_mock.supported_exchanges = ["binance"]
    exchange_mock.rate_limits = {
        "binance": {
    ...
    config.exchange = exchange_mock  # Changed from config.exchanges to config.exchange
...
class TestBinanceWebSocketHandler:
    ...
    async def test_initialization(self, mock_config):
        ...
        mock_config.exchange.binance_websocket_interval = "100ms"
