...
class TestABTestFramework:
    ...
    def test_calculate_statistical_power(self, ab_framework):
        ...
        power_result = ab_framework._calculate_statistical_power(
            test=Mock(minimum_effect_size=0.01, confidence_level=0.95, statistical_power=0.8, primary_metric="sharpe_ratio"), 
    ...
    def test_validate_test_configuration_invalid_confidence(self, ab_framework, sample_variants):
        ...
        test = ABTest(
            "invalid_conf", "Invalid", "Description", 
            sample_variants, confidence_level=1.5  # > 1.0
        )
    ...
    def test_perform_significance_tests(self, mock_ttest, ab_framework):
        ...
        results = ab_framework._perform_significance_tests(
            test_mock, control_mock, treatment_mock
        )
