...
class TestFinancialDataValidation:
    ...
    def test_validate_order_request_limit_order_no_price(self):
        """Test order request validation with limit order but no price."""
        order_request = OrderRequest(
            symbol="BTC/USDT",
            side=OrderSide.BUY,
    ...
    def test_validate_market_data_invalid_price(self):
        ...
        market_data = MarketData(
            symbol="BTC/USDT",
            price=Decimal('-50000.0'),  # Negative price
            volume=Decimal('1000.0'),
            timestamp=datetime.now()
        )
    ...
    def test_validate_market_data_invalid_volume(self):
        ...
        market_data = MarketData(
            symbol="BTC/USDT",
            price=Decimal('50000.0'),
            volume=Decimal('-1000.0'),  # Negative volume
            timestamp=datetime.now()
        )
...
class TestBusinessRuleValidation:
    ...
    def test_validate_position_limits_valid(self):
        ...
        position = Position(
            symbol="BTC/USDT",
            quantity=Decimal('0.000001'),  # Extremely small position: 0.000001 BTC
    ...
    def test_validate_position_limits_zero_positions(self):
        ...
        position = Position(
            symbol="BTC/USDT",
            quantity=Decimal('0.0'),  # Zero size
            entry_price=Decimal('50000.0'),
    ...
    def test_validate_position_limits_negative_size(self):
        ...
        position = Position(
            symbol="BTC/USDT",
            quantity=Decimal('-0.000001'),  # Extremely small negative position
            entry_price=Decimal('50000.0'),
        ...
        # Position value = 0.000001 BTC * 49000 USD = 0.049 USD
        # This should be less than the 0.1 limit
