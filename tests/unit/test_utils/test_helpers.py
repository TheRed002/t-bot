...
class TestMathematicalUtilities:
    ...
    def test_calculate_sharpe_ratio_invalid_risk_free_rate(self):
        ...
        # This should not raise an error as the function doesn't validate risk_free_rate
        result = calculate_sharpe_ratio(returns, -0.02)
        assert isinstance(result, float)
    ...
    def test_calculate_correlation_success(self):
        ...
        assert isinstance(result, float)
        assert abs(result - 1.0) < 1e-10  # Perfect positive correlation with tolerance
    ...
    def test_calculate_correlation_negative_correlation(self):
        ...
        assert isinstance(result, float)
        assert abs(result - (-1.0)) < 1e-10  # Perfect negative correlation with tolerance
...
class TestNetworkUtilities:
    ...
    async def test_test_connection_success(self):
        ...
        # This function doesn't exist in helpers, so let's test measure_latency instead
    ...
    async def test_test_connection_failure(self):
        ...
        # This function doesn't exist in helpers, so let's test ping_host instead
