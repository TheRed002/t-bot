...
class TestFinancialCalculatorBasicMethods:
    ...
    def test_moving_average_calculation(self):
        ...
        prices = tuple(
            [Decimal("100"), Decimal("102"), Decimal("101"), Decimal("103"), Decimal("105")]
        )
        period = 3
    ...
    def test_position_size_volatility_adjusted(self):
        ...
        result = self.calculator.position_size_volatility_adjusted(
            capital, risk_per_trade, stop_distance, volatility
        )
        assert isinstance(result, Decimal)
        assert result > 0
    ...
    def test_risk_reward_ratio_invalid_prices(self):
        ...
        result = self.calculator.risk_reward_ratio(Decimal("100"), Decimal("105"), Decimal("115"))
        assert isinstance(result, Decimal)
        assert result > 0
