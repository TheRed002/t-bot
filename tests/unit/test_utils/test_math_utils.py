...
class TestCalculatePercentageChange:
    ...
    def test_zero_old_value_raises_error(self):
        ...
        with pytest.raises(ValidationError, match="Cannot calculate percentage change with zero old value"):
...
class TestCalculateSharpeRatio:
    ...
    def test_positive_sharpe_ratio(self):
        ...
        returns = [Decimal("0.01"), Decimal("0.02"), Decimal("-0.005"), Decimal("0.015"), Decimal("0.01")]
...
class TestCalculateVar:
    ...
    def test_var_calculation(self):
        ...
        returns = [Decimal("0.01"), Decimal("-0.02"), Decimal("0.015"), Decimal("-0.01"), Decimal("0.005")]
