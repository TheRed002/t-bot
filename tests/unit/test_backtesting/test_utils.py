...
class TestConvertMarketRecordsToDataframe:
    ...
    def test_convert_valid_records(self):
        ...
        # Create simple objects instead of MagicMock to avoid comparison issues
        class MarketRecord:
        ...
        class MarketRecordWithDataTimestamp:
            def __init__(self, data_timestamp, open_p, high_p, low_p, close_p, vol):
        ...
        record2 = MarketRecordWithDataTimestamp(
        ...
        # Check values (should be sorted by timestamp)
