...
class TestDataValidator:
    ...
    @pytest.mark.asyncio
    async def test_validate_market_data_valid(self, validator: DataValidator, valid_market_data: MarketData):
    ...
    async def test_validate_signal_invalid_confidence(self, validator: DataValidator):
        ...
        # that should still pass validation but might have business logic issues
        edge_signal = Signal(
            direction=SignalDirection.BUY,
        ...
        # Should be valid from Pydantic perspective, but might have business logic issues
    ...
    @pytest.mark.asyncio
    async def test_validate_cross_source_consistency_symbol_mismatch(self, validator: DataValidator):
    ...
    @pytest.mark.asyncio
    async def test_validator_performance(self, validator: DataValidator, valid_market_data: MarketData):
