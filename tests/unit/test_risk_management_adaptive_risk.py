...
class TestAdaptiveRiskManager:
    ...
    def test_initialization(self, config, regime_detector):
        ...
        assert MarketRegime.CRISIS in manager.regime_adjustments
    
    @pytest.mark.asyncio
    async def test_calculate_adaptive_position_size_low_volatility(self, adaptive_risk_manager, sample_signal):
        ...
        # Should be larger than base size due to low volatility multiplier (1.2)
    ...
    @pytest.mark.asyncio
    async def test_calculate_adaptive_position_size_high_volatility(self, adaptive_risk_manager, sample_signal):
        ...
        # Should be smaller than base size due to high volatility multiplier (0.7)
        base_size = portfolio_value * Decimal("0.02")
    ...
    @pytest.mark.asyncio
    async def test_calculate_adaptive_position_size_crisis(self, adaptive_risk_manager, sample_signal):
        """Test adaptive position size calculation for crisis regime."""
        portfolio_value = Decimal("10000")
        
        size = await adaptive_risk_manager.calculate_adaptive_position_size(
            sample_signal, MarketRegime.CRISIS, portfolio_value
        )
    ...
    @pytest.mark.asyncio
    async def test_calculate_adaptive_stop_loss_low_volatility(self, adaptive_risk_manager, sample_signal):
        ...
        assert stop_loss > base_stop_loss  # Tighter stop (higher price for buy)
    
    @pytest.mark.asyncio
    async def test_calculate_adaptive_stop_loss_high_volatility(self, adaptive_risk_manager, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_adaptive_take_profit_low_volatility(self, adaptive_risk_manager, sample_signal):
    ...
    @pytest.mark.asyncio
    async def test_calculate_adaptive_take_profit_high_volatility(self, adaptive_risk_manager, sample_signal):
    ...
    async def test_calculate_adaptive_portfolio_limits_crisis(self, adaptive_risk_manager):
        ...
        adaptive_limits = await adaptive_risk_manager.calculate_adaptive_portfolio_limits(
            MarketRegime.CRISIS, base_limits
        )
    ...
    @pytest.mark.asyncio
    async def test_run_stress_test_market_crash(self, adaptive_risk_manager, sample_portfolio_positions):
        ...
        assert results['stressed_value'] < results['initial_value']  # Market crash
    ...
    @pytest.mark.asyncio
    async def test_run_stress_test_flash_crash(self, adaptive_risk_manager, sample_portfolio_positions):
        ...
        assert results['initial_value'] > 0
        assert results['stressed_value'] < results['initial_value']  # Flash crash
        assert results['value_change'] < 0  # Negative change
        assert results['value_change_pct'] < 0  # Negative percentage
        assert results['max_drawdown'] < 0  # Negative drawdown
    
    @pytest.mark.asyncio
    async def test_run_stress_test_volatility_spike(self, adaptive_risk_manager, sample_portfolio_positions):
        ...
        assert results['initial_value'] > 0
        assert results['stressed_value'] < results['initial_value']  # Volatility spike
        assert results['value_change'] < 0  # Negative change
        assert results['value_change_pct'] < 0  # Negative percentage
        assert results['max_drawdown'] < 0  # Negative drawdown
    
    @pytest.mark.asyncio
    async def test_run_stress_test_unknown_scenario(self, adaptive_risk_manager, sample_portfolio_positions):
    ...
    def test_get_stress_test_scenarios(self, adaptive_risk_manager):
        ...
        expected_scenarios = ['market_crash', 'flash_crash', 'volatility_spike', 'correlation_breakdown']
