...
class TestDynamicRiskManagementIntegration:
    ...
    @pytest.mark.asyncio
    async def test_integration_regime_detection_and_adaptive_sizing(self, 
    ...
    @pytest.mark.asyncio
    async def test_integration_regime_detection_and_adaptive_stop_loss(self, 
                                                                      adaptive_risk_manager, 
                                                                      sample_signal,
                                                                      high_volatility_market_data):
    ...
    @pytest.mark.asyncio
    async def test_integration_regime_detection_and_adaptive_take_profit(self, 
                                                                        adaptive_risk_manager, 
                                                                        sample_signal,
                                                                        high_volatility_market_data):
    ...
    @pytest.mark.asyncio
    async def test_integration_regime_detection_and_portfolio_limits(self, 
                                                                   adaptive_risk_manager,
                                                                   high_volatility_market_data):
        ...
        if regime in [MarketRegime.HIGH_VOLATILITY, MarketRegime.CRISIS]:
            ...
            # If regime detection doesn't work as expected, just verify the limits are valid
            assert adaptive_limits['max_positions'] <= base_limits['max_positions']
            assert adaptive_limits['max_portfolio_exposure'] <= base_limits['max_portfolio_exposure']
    
    @pytest.mark.asyncio
    async def test_integration_low_volatility_scenario(self, 
                                                      adaptive_risk_manager, 
                                                      sample_signal,
    ...
    @pytest.mark.asyncio
    async def test_integration_regime_change_detection(self, adaptive_risk_manager, sample_market_data):
        ...
        await adaptive_risk_manager.regime_detector._check_regime_change(new_regime)
        ...
        assert history[0].from_regime == initial_regime
        assert history[0].to_regime == new_regime
    
    @pytest.mark.asyncio
    async def test_integration_stress_testing_with_regime_detection(self, 
                                                                  adaptive_risk_manager,
    ...
    async def test_integration_configuration_validation(self):
        ...
        assert adaptive_manager.base_position_size_pct == 0.02
    ...
    @pytest.mark.asyncio
    async def test_integration_stress_test_scenarios(self, adaptive_risk_manager, sample_portfolio_positions):
