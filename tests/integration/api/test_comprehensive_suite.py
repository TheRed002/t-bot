...
class APITester:
    ...
    def test_endpoint(
        self, endpoint: str, method: str = "GET", auth_token: str | None = None
            ...
            for endpoint in endpoints:
                ...
                if status_code in [401, 403]:
                    ...
                    if auth_status_code == 200:
                        status_code, status_desc, response_data = (
                            auth_status_code,
                            auth_status_desc,
                            auth_response_data,
                        )
                    ...
                    if status_code == 200:
                        ...
                        self.results["not_implemented"].append(
                            {"endpoint": endpoint, "category": category, "status_code": status_code}
                        )
                    else:
    ...
    def _generate_summary(self) -> None:
        ...
        self.results["summary"] = {
            ...
            "implementation_rate": f"{((working + auth_required) / total * 100):.1f}%"
            if total > 0
            else "0%",
        }
