...
class TestDynamicStrategiesIntegration:
    ...
    @pytest.mark.asyncio
    async def test_adaptive_momentum_with_real_regime_detection(
        self, adaptive_momentum_config, real_regime_detector, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_volatility_breakout_with_real_regime_detection(
        self, volatility_breakout_config, real_regime_detector, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_adaptive_momentum_with_real_adaptive_risk(
        self, adaptive_momentum_config, real_adaptive_risk_manager, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_volatility_breakout_with_real_adaptive_risk(
        self, volatility_breakout_config, real_adaptive_risk_manager, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_full_integration_adaptive_momentum(
        self,
        adaptive_momentum_config,
        real_regime_detector,
        real_adaptive_risk_manager,
    ...
    @pytest.mark.asyncio
    async def test_full_integration_volatility_breakout(
        self,
    ...
    @pytest.mark.asyncio
    async def test_regime_transition_handling(
        self, adaptive_momentum_config, real_regime_detector, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_adaptive_risk_parameter_adjustment(
        self, volatility_breakout_config, real_adaptive_risk_manager, sample_market_data_series
    ):
    ...
    async def test_error_handling_and_graceful_degradation(
        self, adaptive_momentum_config, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_strategy_configuration_validation_integration(
        self, adaptive_momentum_config, volatility_breakout_config
    ):
    ...
    @pytest.mark.asyncio
    async def test_signal_validation_integration(
        self, adaptive_momentum_config, volatility_breakout_config, sample_market_data_series
    ):
    ...
    @pytest.mark.asyncio
    async def test_exit_condition_integration(
        self, adaptive_momentum_config, volatility_breakout_config, sample_market_data_series
    ):
        ...
        # Test with first 10 data points
        for market_data in sample_market_data_series[:10]:
