...
class TestSystemIntegration:
    ...
    def test_import_validation(self):
        ...
        assert len(circular_deps) < 10, f"Too many circular dependencies found: {len(circular_deps)}"
    ...
    def test_config_validation(self):
        ...
        critical_errors = [e for e in results["errors"] if "schema" in e.lower() or "main" in e.lower()]
