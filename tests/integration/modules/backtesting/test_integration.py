...
class TestBacktestingModuleIntegration:
    ...
    async def mock_config(self):
        ...
        # Add common config attributes that might be accessed
        config.database = {"url": "sqlite:///:memory:"}
        config.logging = {"level": "INFO"}
        config.backtesting = {"cache_enabled": True}
        return config
    ...
    async def test_strategy_service_backtest_integration(self):
        ...
        # Verify that the service integration worked correctly
        # The fact that run_backtest was called means the integration is working
    ...
    async def test_optimization_integration_uses_service_layer(self):
        ...
        # OptimizationIntegration is deprecated - testing OptimizationService instead
        # This test verifies proper service layer usage
        ...
        # Should use service layer pattern for backtesting integration
        # Either BacktestService or IBacktestIntegrationService indicates proper service layer usage
        has_backtest_service = 'BacktestService' in source
        has_backtest_integration = 'IBacktestIntegrationService' in source or 'BacktestIntegration' in source

        assert has_backtest_service or has_backtest_integration, "Optimization should use service layer for backtesting integration"
