"""
Bot Management Module Integration Test Configuration.

Provides pytest fixtures for bot management integration tests with full DI support.
NO MOCKS - Uses real services from DI container.
"""
