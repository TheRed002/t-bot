...
class TestP009Integration:
    ...
    async def test_complete_emergency_cycle(self, mock_config, mock_risk_manager, mock_exchange):
        ...
        with patch('src.risk_management.circuit_breakers.ErrorHandler', return_value=Mock()), \
            ...
            emergency_controls = EmergencyControls(mock_config, mock_risk_manager, circuit_breaker_manager)
            ...
            data = {
                ...
                "daily_pnl": Decimal("-600"),  # 6% loss, should trigger daily loss breaker
    ...
    @pytest.mark.asyncio
    async def test_emergency_with_positions_and_orders(self, mock_config, mock_risk_manager, mock_exchange):
    ...
    async def test_system_failure_scenario(self):
        ...
        with patch('src.risk_management.circuit_breakers.ErrorHandler', return_value=Mock()), \
            ...
            failure_data = {
                ...
                "model_confidence": Decimal("0.1"),  # Low confidence due to system issues
                "total_requests": 50,
