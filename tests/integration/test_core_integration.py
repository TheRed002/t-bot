...
class TestCoreIntegration:
    ...
    def test_exchange_integrations(self):
        ...
        try:
            from src.exchanges.base import EnhancedBaseExchange, BaseExchange
    ...
    def test_risk_management_integration(self):
        ...
        try:
            ...
            risk_service = RiskService(config)  # Use RiskService instead of deprecated PositionSizer
    ...
    def test_integration_health_summary(self):
        ...
        logger.info(f"Integration Health: {health_percentage:.1f}% ({healthy_components}/{total_components} components healthy)")
