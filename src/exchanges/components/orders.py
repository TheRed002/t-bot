...
class OrderManager:
    ...
    def __init__(self, connection: ConnectionManager, logger: Any = None):
        """
    ...
    async def cancel_order(self, order_id: str, symbol: str | None = None) -> dict[str, Any]:
        ...
        try:
            response = await self.connection.request(
                method="DELETE", endpoint="/api/v3/order", params=params, signed=True
            )
    ...
    async def get_order(self, order_id: str, symbol: str | None = None) -> dict[str, Any]:
        ...
        try:
            response = await self.connection.request(
                method="GET", endpoint="/api/v3/order", params=params, signed=True
            )
    ...
    async def get_open_orders(self, symbol: str | None = None) -> list[dict[str, Any]]:
        ...
        try:
            response = await self.connection.request(
                method="GET", endpoint="/api/v3/openOrders", params=params, signed=True
            )
