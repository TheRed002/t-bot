...
class ExchangeConfig(BaseConfig):
    ...
    binance_api_key: str = Field(
        default="", description="Binance API key", alias="BINANCE_API_KEY"
    )
    ...
    okx_api_key: str = Field(
        default="", description="OKX API key", alias="OKX_API_KEY"
    )
    okx_api_secret: str = Field(
        default="", description="OKX API secret", alias="OKX_API_SECRET"
    )
    okx_passphrase: str = Field(
        default="", description="OKX API passphrase", alias="OKX_PASSPHRASE"
    )
    okx_testnet: bool = Field(
        default=True, description="Use OKX testnet", alias="OKX_TESTNET"
    )
    ...
    rate_limit_buffer: float = Field(
        ...
        ge=0.1,
        le=1.0,
        description="Rate limit buffer (0.9 = use 90% of limit)"
    )
