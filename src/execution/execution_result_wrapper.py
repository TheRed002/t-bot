...
from src.core.types import ExecutionResult as CoreExecutionResult, OrderRequest, ExecutionAlgorithm
...
class ExecutionResultWrapper:
    ...
    def __init__(self, core_result: CoreExecutionResult, original_order: OrderRequest, algorithm: ExecutionAlgorithm | None = None):
        """
    ...
    # Proxy methods
    def add_fill(self, price: Decimal, quantity: Decimal, timestamp: datetime, order_id: str):
