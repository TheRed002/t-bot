...
from src.utils.decimal_utils import DecimalEncoder
...
class DecimalPrecisionMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, financial_fields: List[str] = None):
        """
        ...
        self.financial_fields = financial_fields or [
            'price', 'quantity', 'amount', 'balance', 'value', 'cost',
            'pnl', 'profit', 'loss', 'fee', 'commission', 'capital',
            'drawdown', 'return', 'allocation', 'exposure', 'margin',
            'collateral', 'premium', 'strike', 'notional', 'principal',
            'interest', 'dividend', 'yield', 'rate', 'spread', 'basis',
            # Portfolio-related
            'total_value', 'total_pnl', 'unrealized_pnl', 'realized_pnl',
            'market_value', 'cost_basis', 'entry_price', 'current_price',
            'stop_price', 'take_profit', 'stop_loss',
            # Risk-related
            'var', 'expected_shortfall', 'sharpe_ratio', 'profit_factor',
            'calmar_ratio', 'max_drawdown', 'average_win', 'average_loss',
            # Position-related
            'position_size', 'allocated_capital', 'available_balance',
            'locked_balance', 'total_balance', 'free_balance',
            # Trading-related
            'order_value', 'fill_price', 'average_fill_price', 'slippage',
            'execution_cost', 'bid', 'ask', 'last_price', 'volume',
        ]
        
        # Patterns to match financial fields with suffixes/prefixes
        self.financial_patterns = [
            '_price', '_amount', '_value', '_balance', '_pnl', '_cost',
            '_fee', '_commission', '_capital', '_allocation', '_exposure',
            'price_', 'amount_', 'value_', 'balance_', 'pnl_', 'cost_',
        ]
            ...
            if "application/json" in content_type:
                ...
                if body:
                    try:
                        ...
                        logger.debug(f"Converted request body for decimal precision: {request.url.path}")
...
class DecimalValidationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, critical_endpoints: List[str] = None):
        """
