...
class FileUtils:
    ...
    def save_config_file(file_path: str, config: Dict[str, Any]) -> None:
        ...
        try:
            ...
            raise ValidationError(f"Cannot save config file '{file_path}': {str(e)}")
    ...
    def delete_file(file_path: str) -> None:
        ...
        try:
            ...
            raise ValidationError(f"Cannot delete file '{file_path}': {str(e)}")
    ...
    def get_file_size(file_path: str) -> int:
        ...
        try:
            ...
            raise ValidationError(f"Cannot get file size for '{file_path}': {str(e)}")
    ...
    def list_files(directory: str, pattern: str = "*") -> list:
        ...
        try:
            ...
            raise ValidationError(f"Cannot list files in '{directory}': {str(e)}")