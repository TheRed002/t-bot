...
from decimal import Decimal, ROUND_DOWN, ROUND_HALF_UP, ROUND_UP, Context, getcontext, setcontext
...
def to_decimal(value: Union[str, int, float, Decimal], context: Optional[Context] = None) -> Decimal:
    """
