...
class RedisClient:
    ...
    async def set(self, key: str, value: Any, ttl: Optional[int] = None, namespace: str = "trading_bot") -> bool:
    ...
    async def get(self, key: str, namespace: str = "trading_bot") -> Optional[Any]:
        """Get a value by key."""
        try:
            namespaced_key = self._get_namespaced_key(key, namespace)
    ...
    async def hget(self, key: str, field: str, namespace: str = "trading_bot") -> Optional[Any]:
    ...
    async def get_balance(self, user_id: str, exchange: str) -> Optional[Dict[str, Any]]:
