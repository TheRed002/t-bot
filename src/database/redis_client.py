...
from src.utils.formatters import format_api_response, format_json_data
...
class RedisClient:
    ...
    def _get_namespaced_key(
            self,
            key: str,
            namespace: str = "trading_bot") -> str:
    ...
    async def set(
            ...
            namespace: str = "trading_bot") -> bool:
        ...
        try:
            ...
            raise DataError(f"Redis set operation failed: {str(e)}")

    async def get(
            self,
            key: str,
            namespace: str = "trading_bot") -> Optional[Any]:
        """Get a value by key."""
        try:
            namespaced_key = self._get_namespaced_key(key, namespace)
            ...
            raise DataError(f"Redis get operation failed: {str(e)}")
    ...
    async def delete(self, key: str, namespace: str = "trading_bot") -> bool:
        ...
        try:
            ...
            logger.error(
                ...
                key=key,
                error=str(e))
            raise DataError(f"Redis delete operation failed: {str(e)}")
    ...
    async def exists(self, key: str, namespace: str = "trading_bot") -> bool:
        ...
        try:
            ...
            logger.error(
                ...
                key=key,
                error=str(e))
            raise DataError(f"Redis exists operation failed: {str(e)}")
    ...
    async def expire(
        ...
        try:
            ...
            logger.error(
                ...
                key=key,
                error=str(e))
            raise DataError(f"Redis expire operation failed: {str(e)}")
    ...
    async def ttl(self, key: str, namespace: str = "trading_bot") -> int:
        ...
        try:
            ...
            raise DataError(f"Redis TTL operation failed: {str(e)}")
    ...
    async def hset(self, key: str, field: str, value: Any,
        ...
        try:
            ...
            logger.error(
                ...
                field=field,
                error=str(e))
            raise DataError(f"Redis hset operation failed: {str(e)}")
    ...
    async def hget(
        ...
        try:
            ...
            logger.error(
                ...
                field=field,
                error=str(e))
            raise DataError(f"Redis hget operation failed: {str(e)}")

    async def hgetall(
            self, key: str, namespace: str = "trading_bot") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                "Redis hgetall operation failed",
                key=key,
                error=str(e))
            raise DataError(f"Redis hgetall operation failed: {str(e)}")
    ...
    async def hdel(
        ...
        try:
            ...
            logger.error(
                "Redis hdel operation failed",
                key=key,
                field=field,
                error=str(e))
            raise DataError(f"Redis hdel operation failed: {str(e)}")
    ...
    async def lpush(
        ...
        try:
            ...
            raise DataError(f"Redis lpush operation failed: {str(e)}")
    ...
    async def rpush(
        ...
        try:
            ...
            raise DataError(f"Redis rpush operation failed: {str(e)}")
    ...
    async def lrange(
            ...
            namespace: str = "trading_bot") -> List[Any]:
        ...
        try:
            ...
            logger.error(
                "Redis lrange operation failed",
                key=key,
                error=str(e))
            raise DataError(f"Redis lrange operation failed: {str(e)}")
    ...
    async def sadd(
        ...
        try:
            ...
            raise DataError(f"Redis sadd operation failed: {str(e)}")
    ...
    async def smembers(
        ...
        try:
            ...
            logger.error(
                ...
                key=key,
                error=str(e))
            raise DataError(f"Redis smembers operation failed: {str(e)}")

    # Trading-specific utilities
    async def store_market_data(
            self, symbol: str, data: Dict[str, Any], ttl: int = 300) -> bool:
    ...
    async def debug_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return format_api_response(
                debug_data,
                success=True,
                message="Redis debug info retrieved")
        except Exception as e:
            return format_api_response(
                {},
                success=False,
