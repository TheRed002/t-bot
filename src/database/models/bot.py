...
from src.database.models.base import Base, TimestampMixin, AuditMixin, MetadataMixin, SoftDeleteMixin


class Bot(Base, TimestampMixin, AuditMixin, MetadataMixin, SoftDeleteMixin):
    """Bot model."""
    ...
    status = Column(String(20), nullable=False, default='STOPPED')  # INITIALIZING, RUNNING, PAUSED, STOPPING, STOPPED, ERROR
