...
def upgrade() -> None:
    ...
    op.create_index(
        'idx_bot_instances_user_id',
        'bot_instances',
        ['user_id'],
        unique=False)
    op.create_index(
        'idx_bot_instances_strategy_type',
        'bot_instances',
        ['strategy_type'],
        unique=False)
    op.create_index(
        'idx_bot_instances_exchange',
        'bot_instances',
        ['exchange'],
        unique=False)
    op.create_index(
    ...
    op.create_unique_constraint(
        'unique_user_bot_name', 'bot_instances', [
            'user_id', 'name'])
    op.create_check_constraint(
        'valid_bot_status',
        'bot_instances',
    ...
    op.create_index(
        ...
        unique=False)
    op.create_index(
        'idx_balance_snapshots_exchange',
        'balance_snapshots',
        ['exchange'],
        unique=False)
    op.create_index(
        'idx_balance_snapshots_currency',
        'balance_snapshots',
        ['currency'],
        unique=False)
    op.create_index(
        ...
        unique=False)
    op.create_check_constraint(
        'non_negative_free_balance',
        'balance_snapshots',
        'free_balance >= 0')
    op.create_check_constraint(
        'non_negative_locked_balance',
        'balance_snapshots',
        'locked_balance >= 0')
    op.create_check_constraint(
        'non_negative_total_balance',
        'balance_snapshots',
        'total_balance >= 0')
    ...
    op.create_index(
        ...
        unique=False)
    op.create_unique_constraint(
        'unique_strategy_config', 'strategy_configs', [
            'name', 'version'])
    ...
    op.create_index(
        'idx_performance_metrics_bot_id',
        'performance_metrics',
        ['bot_id'],
        unique=False)
    op.create_index(
        ...
        unique=False)
    op.create_unique_constraint(
        'unique_daily_metrics', 'performance_metrics', [
            'bot_id', 'metric_date'])
    op.create_check_constraint(
        'non_negative_total_trades',
        'performance_metrics',
        'total_trades >= 0')
    op.create_check_constraint(
        'non_negative_winning_trades',
        'performance_metrics',
        'winning_trades >= 0')
    op.create_check_constraint(
        'non_negative_losing_trades',
        'performance_metrics',
        'losing_trades >= 0')
    op.create_check_constraint(
        'valid_win_rate',
