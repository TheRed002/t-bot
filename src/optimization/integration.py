...
from src.core.types import TradingMode, StrategyConfig, StrategyType
...
from src.optimization.bayesian import BayesianOptimizer, BayesianConfig
from src.optimization.analysis import ResultsAnalyzer, PerformanceMetrics
...
class OptimizationIntegration:
    ...
    def __init__(
        self,
        backtesting_engine: Optional[BacktestEngine] = None,
...
def create_strategy_optimization_space() -> ParameterSpace:
    ...
    return (builder
            .add_continuous("position_size_pct", 0.01, 0.05, precision=3)
...
def create_risk_optimization_space() -> ParameterSpace:
    ...
    return (builder
            .add_continuous("max_portfolio_exposure", 0.5, 0.95, precision=2)
