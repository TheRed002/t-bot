...
class NewsDataSource:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise DataSourceError(f"News data source initialization failed: {str(e)}")
    ...
    def _parse_article(self, article_data: Dict[str, Any], query: str) -> Optional[NewsArticle]:
        ...
        try:
            ...
            return NewsArticle(
                ...
                metadata={
                    ...
                    'content': article_data.get('content', '')[:200]  # First 200 chars
                }
            )
    ...
    def _analyze_sentiment(self, text: str) -> tuple[NewsSentiment, float]:
        ...
        if sentiment_score > 0.05:
            ...
            sentiment = NewsSentiment.NEGATIVE if sentiment_score > -0.15 else NewsSentiment.VERY_NEGATIVE
        else:
    ...
    def _filter_and_score_articles(self, articles: List[NewsArticle], symbol: str) -> List[NewsArticle]:
    ...
    async def get_market_sentiment(self, symbols: List[str]) -> Dict[str, Dict[str, float]]:
        ...
        try:
            ...
            raise DataSourceError(f"Market sentiment calculation failed: {str(e)}")
