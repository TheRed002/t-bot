...
from src.core.exceptions import StateError, ValidationError, ExecutionError
from src.core.logging import get_logger
from src.core.types import (
    OrderSide, OrderStatus, OrderType, TradeState, 
    ExecutionResult, OrderRequest, Position
)
...
from src.utils.validators import validate_trade_data
...
class TradeContext:
    ...
    previous_state: Optional[TradeLifecycleState] = None
    ...
    final_fill_timestamp: Optional[datetime] = None
...
class TradeLifecycleManager:
    ...
    def __init__(self, config: Config):
        ...
        self.valid_transitions = {
            TradeLifecycleState.SIGNAL_GENERATED: [
    ...
    async def transition_trade_state(
        ...
        try:
            ...
            await self._log_trade_event(
                trade_id,
                self._state_to_event(new_state),
                event_data or {}
            )
    ...
    async def calculate_trade_performance(self, trade_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if (trade_context.requested_price and 
                trade_context.average_fill_price > 0 and
                trade_context.order_type == OrderType.MARKET):
    ...
    async def _finalize_trade(self, trade_id: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"Trade finalized and moved to history", trade_id=trade_id)
    ...
    def _update_performance_metrics(self, trade_context: TradeContext) -> None:
        ...
        try:
            ...
            if trade_context.quality_score:
                ...
                new_avg = (current_avg * (total_trades - 1) + trade_context.quality_score) / total_trades
